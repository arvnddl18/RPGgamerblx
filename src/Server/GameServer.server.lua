...
local coreRemotes = {
	...
	"OpenQuest", "AcceptQuest", "TurnInQuest", "QuestUpdated", "QuestReward", "OpenQuestLog", "OpenComicScene", "CompleteComicScene",
	...
	"SetPvpMode",
	"AutoFarmToggle", "AutoFarmState", "AutoAttackPerformed", "AutoFarmSkillPerformed", "TargetLockRequest", "TargetLockUpdated",
	"SetResting",
