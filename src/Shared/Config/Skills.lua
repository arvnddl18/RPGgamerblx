...
local Skills = {
	Warrior_AutoAttack = {
		...
		skillType = "melee",
		comboAnims = {
			LocalAnimationBuilder.GetWarriorAuto1(),
			LocalAnimationBuilder.GetWarriorAuto2(),
			LocalAnimationBuilder.GetWarriorAuto3(),
			LocalAnimationBuilder.GetWarriorAuto4(),
			LocalAnimationBuilder.GetWarriorAuto5(),
		},
	...
	Archer_AutoAttack = {
		...
		skillType = "ranged",
		comboAnims = {
			LocalAnimationBuilder.GetArcherAuto1(),
			LocalAnimationBuilder.GetArcherAuto2(),
			LocalAnimationBuilder.GetArcherAuto3(),
			LocalAnimationBuilder.GetArcherAuto4(),
			LocalAnimationBuilder.GetArcherAuto5(),
		},
		comboAdvance = "sequential",
		castTime = 0.7,
	...
	Priest_AutoAttack = {
		...
		coneAngle = 160,
		comboAnims = {
			LocalAnimationBuilder.GetPriestAuto1(),
			LocalAnimationBuilder.GetPriestAuto2(),
			LocalAnimationBuilder.GetPriestAuto3(),
			LocalAnimationBuilder.GetPriestAuto4(),
			LocalAnimationBuilder.GetPriestAuto5(),
		},
		comboAdvance = "sequential",
		castTime = 0.8,
		hitAnimMarker = "Hit",
	...
	Kavalier_AutoAttack = {
		...
		coneAngle = 160,
		comboAnims = {
			LocalAnimationBuilder.GetKavalierAuto1(),
			LocalAnimationBuilder.GetKavalierAuto2(),
			LocalAnimationBuilder.GetKavalierAuto3(),
			LocalAnimationBuilder.GetKavalierAuto4(),
			LocalAnimationBuilder.GetKavalierAuto5(),
		},
		comboAdvance = "sequential",
		castTime = 0.7,
		hitAnimMarker = "Hit",
