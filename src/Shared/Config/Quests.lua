...
local QuestConfig = {
	GoblinMenace = {
		...
		lore = "The goblins have grown bold, creeping closer to our borders each night. They steal our crops, slaughter our livestock, and threaten our families. We need a brave soul to thin their numbers and send a message that we won't be easily broken.",
		hints = "Look for goblins near the outskirts of the village. They usually travel in small packs.",
		requiredLevel = 1,
		repeatable = true,
	...
	CollectHerbs = {
		...
		name = "Collect Herbs",
		npcName = "Herb Master",
		lore = "The fields are ripe with medicinal herbs, but the local wildlife has been too aggressive for me to gather them safely. I need these herbs to brew potions for the wounded.",
		hints = "Herbs grow abundantly in the sunny patches of the forest. Click on them to harvest.",
		requiredLevel = 1,
		repeatable = true,
	...
	TalkToElder = {
		...
		lore = "The Village Elder holds ancient knowledge about the lands. He only speaks to those who show promise.",
		hints = "The Elder can usually be found near the center of the village.",
		requiredLevel = 2,
		repeatable = false,
	...
	ReachMonument = {
		...
		npcName = "Scout",
		lore = "An ancient monument to the north has begun glowing with an eerie light. We must investigate it before it's too late.",
		hints = "Head straight north from the village until you see the glowing stone structure.",
		requiredLevel = 3,
		repeatable = false,
